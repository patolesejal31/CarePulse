    ...
    <Form {...form}>
      ...
      >
        <section className="space-y-4">
          <h1 className="header text-white">{t("welcome")}</h1>
          <p className="text-dark-700">{t("letUsKnow")}</p>
        </section>

        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className="sub-header text-white">{t("personalInfo")}</h2>
          </div>
        ...
        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className="sub-header text-white">{t("medicalInfo")}</h2>
          </div>
        ...
        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className="sub-header text-white">{t("idVerification")}</h2>
          </div>
        ...
        <section className="space-y-6">
          <div className="mb-9 space-y-1">
            <h2 className="sub-header text-white">{t("consentPrivacy")}</h2>
          </div>
